...
Parser.prototype = {
    ...
    parse: function(reporter) {
        ...
        var curNode, openedNode, retDom = {}, lineNo = 1;
            ...
            if (tagProp.isEndTag) {
                ...
                while (openedNode = stack.last()) {
                    ...
                    // deal with non-close tag
                        ...
                        reporter.error('标签 ' + openedNode.tag + ' 未闭合', openedNode.line, null, {'id': 'html-tag-close', 'description':'标签应闭合'});
                        stack.pop();
                    }
                }
            } 
